function Platoon000320_Initialize(arg0)
...
function Platoon000320_Activate(arg0)
    return 
end

function Platoon000320_Deactivate(arg0)
    return 
end

function Platoon000320_Update(arg0)
    local local0 = 10
    local local1 = 5
    local local2 = 5
    local local3 = 0
    ...
    local local16 = 0
    local local17 = -1
    local local18 = arg0:GetMemberNum() - 1 - local17
    goto basicblock_29:
end
