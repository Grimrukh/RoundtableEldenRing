...
function InterruptTableGoal_Common(arg0, arg1, arg2)
    local local0 = false
    local local1 = g_GoalTable[arg2]
    if local1 ~= nil and local1["Interrupt"] ~= nil and local1:Interrupt(arg0, arg1) then
        local0 = true
    end
    return local0
end
...
function _CreateInterruptTypeInfoTable(arg0)
    ...
    local1["bEmpty"] = arg0["Interrupt_DeActivateSpecialEffect"] == nil
    local0[INTERUPT_DeActivateSpecialEffect] = local1
    local1 = {}
    local1.func = function (arg0, arg1, arg2)
    ...
    local1 = {}
    local1.func = function (arg0, arg1, arg2)
        local local0 = _GetInterruptFunc(arg2["Interrupt_LadderWait"])
        if local0(arg2, arg0, arg1) then
            return true
        elseif arg1:IsInterruptSubGoalChanged() then
            return true
    ...
    local1["bEmpty"] = arg0["Interrupt_LadderWait"] == nil
    local0[INTERUPT_LadderWait] = local1
    local1 = {}
    local1.func = function (arg0, arg1, arg2)
        local local0 = _GetInterruptFunc(arg2["Interrupt_AIJump"])
        if local0(arg2, arg0, arg1) then
            return true
        elseif arg1:IsInterruptSubGoalChanged() then
            return true
    ...
    local1["bEmpty"] = arg0["Interrupt_AIJump"] == nil
    local0[INTERUPT_AIJump] = local1
    local1 = {}
    local1.func = function (arg0, arg1, arg2)
        local local0 = _GetInterruptFunc(arg2["Interrupt_FindUnfavorableFailedPoint"])
        if local0(arg2, arg0, arg1) then
            return true
        elseif arg1:IsInterruptSubGoalChanged() then
            return true
    ...
    local1["bEmpty"] = arg0["Interrupt_FindUnfavorableFailedPoint"] == nil
    local0[INTERUPT_FindUnfavorableFailedPoint] = local1
    local1 = {}
    local1.func = function (arg0, arg1, arg2)
        local local0 = _GetInterruptFunc(arg2["Interrupt_UnfavorableAttack"])
        if local0(arg2, arg0, arg1) then
            return true
        elseif arg1:IsInterruptSubGoalChanged() then
            return true
    ...
    local1["bEmpty"] = arg0["Interrupt_UnfavorableAttack"] == nil
    local0[INTERUPT_UnfavorableAttack] = local1
    return local0
end
...
function _InterruptTableGoal_DeActivateSpecialEffect(arg0, arg1, arg2)
    ...
    for local1 = 0 - local0, arg1:GetSpecialEffectInactivateInterruptNum() - 1, local0 do
        local local2 = _GetInterruptFunc(arg0["Interrupt_DeActivateSpecialEffect"])
