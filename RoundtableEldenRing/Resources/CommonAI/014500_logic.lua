function common14500_Logic(arg0)
    ...
    if not arg0:IsUseFlyRoute() and arg0:IsChangeState() then
        ...
        elseif arg0:IsSearchLowState() and local0 == AI_TARGET_STATE__NONE then
            arg0:AddTopGoal(GOAL_COMMON_AttackTunableSpin, 10, 3024, TARGET_SEARCH, DIST_NONE, 0, 90)
        elseif arg0:IsSearchHighState() and local0 == AI_TARGET_STATE__SEARCH then
            arg0:AddTopGoal(GOAL_COMMON_AttackTunableSpin, 4, 3025, TARGET_SEARCH, DIST_NONE, 0, 90)
            arg0:SetTimer(2, 6)
        elseif arg0:IsCautionState() and local0 == AI_TARGET_STATE__NONE then
        ...
        elseif (local0 == AI_TARGET_STATE__SEARCH or local0 == AI_TARGET_STATE__SEARCH2) and arg0:IsSearchLowState() == false and arg0:IsSearchHighState() == false and arg0:IsCautionState() == false and arg0:IsBattleState() == false then
    ...
    if not arg0:IsUseFlyRoute() then
        ...
        elseif arg0:IsSearchHighState() then
            if arg0:IsFinishTimer(2) and arg0:GetRandam_Int(1, 100) < 20 and 20 <= arg0:GetAttackPassedTime(3027) then
        ...
        elseif arg0:IsCautionState() then
            arg0:AddTopGoal(GOAL_COMMON_Stay, 1, 0, TARGET_ENE_0)
            arg0:SetNumber(5, 0)
        elseif arg0:GetNumber(5) == 0 and 12 <= arg0:GetAttackPassedTime(3023) then
