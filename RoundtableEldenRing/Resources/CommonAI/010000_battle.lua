...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    Common_Battle_Activate(arg1, arg2, local0, local1, REGIST_FUNC(arg1, arg2, ishijunTest10000_ActAfter_AdjustSpace))
    return 
end
...
function ishijunTest10000_Act40(arg0, arg1, arg2)
    ...
    local local0 = arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, 3015, TARGET_ENE_0, DIST_None, 0, 0)
    local0:TimingSetTimer(1, 24, AI_TIMING_SET__UPDATE_SUCCESS)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    elseif arg1:IsInterupt(INTERUPT_UseItem) and arg1:GetNumber(1) == 4 then
        ...
        return true
    elseif arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(150) then
        arg2:ClearSubGoal()
