...
public class BONFIRE_WARP_SUB_CATEGORY_PARAM_ST
{
    ...
    public class Row(PARAM.Row row) : IParamRow
    {
        ...
        public ushort tabId
        {
            get => (ushort)row["tabId"].Value;
            set => row["tabId"].Value = value;
        }

        // Unknown.
        public ushort sortId
        {
            get => (ushort)row["sortId"].Value;
    ...
    /// </summary>
    public BONFIRE_WARP_SUB_CATEGORY_PARAM_ST(PARAM param)
    {
    ...
    /// </summary>
    public BONFIRE_WARP_SUB_CATEGORY_PARAM_ST(MemoryPARAM memoryParam)
    {
