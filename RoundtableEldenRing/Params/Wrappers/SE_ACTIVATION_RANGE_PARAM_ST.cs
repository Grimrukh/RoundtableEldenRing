...
public class SE_ACTIVATION_RANGE_PARAM_ST
{
    ...
    public class Row(PARAM.Row row) : IParamRow
    {
        ...
        {
            get => (float)row["activateRange"].Value;
    ...
    /// </summary>
    public SE_ACTIVATION_RANGE_PARAM_ST(PARAM param)
    {
    ...
    /// </summary>
    public SE_ACTIVATION_RANGE_PARAM_ST(MemoryPARAM memoryParam)
    {
