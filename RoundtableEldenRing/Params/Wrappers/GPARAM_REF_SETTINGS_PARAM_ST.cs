...
public class GPARAM_REF_SETTINGS_PARAM_ST
{
    ...
    public class Row(PARAM.Row row) : IParamRow
    {
        ...
        // Unknown.
        public int RefTargetMapId
        {
            get => (int)row["RefTargetMapId"].Value;
            set => row["RefTargetMapId"].Value = value;
        }
    ...
    /// </summary>
    public GPARAM_REF_SETTINGS_PARAM_ST(PARAM param)
    {
    ...
    /// </summary>
    public GPARAM_REF_SETTINGS_PARAM_ST(MemoryPARAM memoryParam)
    {
