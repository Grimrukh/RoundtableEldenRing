...
public class WEATHER_LOT_TEX_PARAM_ST
{
    ...
    public class Row(PARAM.Row row) : IParamRow
    {
        ...
        // Unknown.
        public int weatherLogId
        {
            get => (int)row["weatherLogId"].Value;
            set => row["weatherLogId"].Value = value;
        }
    ...
    /// </summary>
    public WEATHER_LOT_TEX_PARAM_ST(PARAM param)
    {
    ...
    /// </summary>
    public WEATHER_LOT_TEX_PARAM_ST(MemoryPARAM memoryParam)
    {
