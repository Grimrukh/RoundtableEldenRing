...
public class MAP_PIECE_TEX_PARAM_ST
{
    ...
    public class Row(PARAM.Row row) : IParamRow
    {
        ...
        {
            get => (int)row["saveMapNameId"].Value;
            set => row["saveMapNameId"].Value = value;
        }

        // Unknown.
        public int multiPlayAreaId
        {
            get => (int)row["multiPlayAreaId"].Value;
            set => row["multiPlayAreaId"].Value = value;
        }
    ...
    /// </summary>
    public MAP_PIECE_TEX_PARAM_ST(PARAM param)
    {
    ...
    /// </summary>
    public MAP_PIECE_TEX_PARAM_ST(MemoryPARAM memoryParam)
    {
