...
namespace PropertyHook
{
    ...
    public abstract class PHook
    {
        ...
        /// <summary>
        /// List of `PHPointerAOB` pointers to scan for automatically when hooked.
        /// (The `ScanAOB()` method of each pointer will be called.)
        /// </summary>
        public List<PHPointerAOB> AOBPointers;
        ...
        /// <summary>
        /// Allocates a memory region with the given size and permissions. Address is chosen automatically.
        /// </summary>
        ...
        /// <summary>
        /// Allocates a memory region with the given size and permissions at the specified address.
        /// </summary>
        public IntPtr Allocate(IntPtr lpAddress, uint size, uint flProtect = Kernel32.PAGE_READWRITE)
        {
            return Kernel32.VirtualAllocEx(Handle, lpAddress, (IntPtr)size, Kernel32.MEM_RESERVE | Kernel32.MEM_COMMIT, flProtect);
        }
        
        /// <summary>
        /// Allocates a memory region with the given size and permissions as close to `basePtr` (afterward) as possible.
        /// `basePtr` defaults to the main module's base address.
        /// </summary>
        /// <param name="size"></param>
        /// <param name="basePtr"></param>
        /// <param name="flProtect"></param>
        /// <returns></returns>
        public IntPtr AllocateClose(int size, IntPtr? basePtr = null, uint flProtect = Kernel32.PAGE_READWRITE)
        {
            ...
            {
                long distance = baseAddress - Kernel32.SystemInfo.dwAllocationGranularity * i;
        ...
        /// </summary>
        public bool Free(IntPtr address, uint dwFreeType = Kernel32.MEM_RELEASE)
        {
            return Kernel32.VirtualFreeEx(Handle, address, IntPtr.Zero, dwFreeType);
        }
