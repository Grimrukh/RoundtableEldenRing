...
namespace PropertyHook
{
    ...
    public abstract class PHPointer
    {
        ...
        /// <summary>
        /// Whether the pointer is non-zero (usually means valid).
        /// </summary>
        ...
        /// <summary>
        /// Creates a new PHPointer that is a child of this pointer.
        /// </summary>
        public PHPointer CreateChildPointer(params int[] offsets)
        {
            return Hook.CreateChildPointer(this, offsets);
        }
        ...
        /// Evaluates the base address and follows each offset to find the final address.
        ///
        /// Returns `true` only if a non-zero final address if found.
        /// </summary>
        /// <param name="address"></param>
        /// <returns></returns>
        public bool TryResolve(out IntPtr address)
        {
            address = Resolve();
