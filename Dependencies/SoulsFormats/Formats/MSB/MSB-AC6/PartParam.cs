        ...
        public abstract class Part : Entry, IMsbPart
        {
            ...
            public abstract class EnemyBase : Part
            {
                ...
                internal override void GetNames(Entries entries)
                {
                    ...
                    WalkRouteName = MSB.FindName(entries.PatrolInfos.Names, PatrolInfoIndex);
                }
                ...
                internal override void GetIndices(Entries entries)
                {
                    ...
                    PatrolInfoIndex = (short)MSB.FindIndex(this, entries.PatrolInfos.Indices, WalkRouteName);
                }
            }
