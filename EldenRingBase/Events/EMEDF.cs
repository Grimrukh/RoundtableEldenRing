...
public static class EMEDF
{
    ...
    /// TODO
    /// </summary>
    public static Instruction AwaitAssetDestrucionState(
        byte state,
        uint asset,
        ComparisonType targetComparisonType = ComparisonType.Equal,
        float targetCount = 1.0f)
    ...
    public static Instruction AwaitAssetDestroyed(
        ...
        ComparisonType targetComparisonType = ComparisonType.Equal,
        float targetCount = 1.0f)
        => AwaitAssetDestrucionState(1, asset, targetComparisonType, targetCount);
    ...
    public static Instruction AwaitAssetNotDestroyed(
        ...
        ComparisonType targetComparisonType = ComparisonType.Equal,
        float targetCount = 1.0f)
        => AwaitAssetDestrucionState(0, asset, targetComparisonType, targetCount);
