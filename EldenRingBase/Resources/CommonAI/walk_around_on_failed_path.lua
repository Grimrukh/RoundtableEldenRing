REGISTER_DBG_GOAL_PARAM(GOAL_COMMON_WalkAround_On_FailedPath, 0, "パスチェック間隔", 0)
...
function WalkAroundFailedPath_AddInnerGoal(arg0, arg1)
    ...
    if arg0:IsRiding(TARGET_SELF) == true then
        if 2 <= local1 then
            arg1:AddSubGoal(GOAL_COMMON_MoveToSomewhere, 30, local0, AI_DIR_TYPE_CENTER, 1, TARGET_SELF, true)
